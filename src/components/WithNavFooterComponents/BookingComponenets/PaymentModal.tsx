...
const PaymentModal = ({ handleOk }: any) => {
      ...
      <div className="my-5">
        {/* <div className='flex justify-start items-center gap-5 border-0 border-b mb-2 pb-2'>
                    <div className='border p-2 rounded-xl h-16 w-20 flex flex-col justify-center items-center hover:border-primary'>
                        <Image src={AllImages.VisaMastercard} height={0} width={0} alt='card' className='object-contain h-5 w-14'/>
                        <p>Card</p>
                    </div>
                    <div className='border p-2 rounded-xl h-16 w-20 flex flex-col justify-center items-center hover:border-primary'>
                        <Image src={AllImages.Paypal} height={0} width={0} alt='card' object-contain h-5 w-14/>
                        <p>Paypal</p>
                    </div>
                </div> */}
        <Form
