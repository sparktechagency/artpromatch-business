    ...
    <div>
      ...
      >
        <div className="flex flex-col md:flex-row justify-start items-center gap-3">
          ...
          <div className="mb-2">
            ...
            <p className="text-textSecondary">
              Here&apos;s an overview of your studio&apos;s performance and
              activities today.
            </p>
          </div>
        </div>
        <div className="flex flex-col md:flex-row justify-center items-center gap-5">
          <Link href="/profile">
            <div className="px-20 md:px-6 py-2 rounded-lg border">
              View Profile
            </div>
          </Link>
          {/* <Link href="/discover">
            <div className="px-20 md:px-6 py-2 rounded-lg border bg-primary text-white">
              Discover
            </div>
          </Link> */}
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-10">
        <div className="border rounded-xl border-gray-400/70 p-5">
          ...
          <div className="flex justify-between items-center border-0 border-b pb-2 mb-2">
            <div className="flex justify-center items-center gap-2">
              ...
              <div>
                ...
                <p className="text-textSecondary">
                  Your active guest spots are visible to artists. Ensure details
                  are accurate to secure more bookings!
                </p>
              </div>
            </div>
            <Link href="/your-bookings">
          ...
          <div className="flex justify-between items-center border-0 border-b pb-2 mb-2">
            <div className="flex justify-center items-center gap-2">
              ...
              <div>
                ...
                <p className="text-textSecondary">
                  rack and manage your upcoming events. Keep details updated to
            ...
            <div className=" flex justify-center items-center gap-2">
              <div>
                <h1 className="text-textSecondary">
                  Registrations:45 of 50 Slots Filled
                </h1>
