    ...
    <div className="container mx-auto px-2 md:px-0">
      ...
      <div className="flex justify-between items-center my-6">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-2">
          <button className="px-3 py-1 rounded-xl border flex justify-center items-center gap-2 border-primary text-primary">
            Specific Availability
          </button>
          <button className="px-3 py-1 rounded-xl border flex justify-center items-center gap-2 border-dashed text-red-500">
            Set Time off
          </button>
