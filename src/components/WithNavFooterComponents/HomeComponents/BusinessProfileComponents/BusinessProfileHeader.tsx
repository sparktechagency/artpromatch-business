    ...
    <div>
      <div className="flex flex-col lg:flex-row justify-between items-center gap-5 lg:gap-0 my-5">
        ...
        {/* <div className="flex flex-col lg:flex-row justify-center items-center gap-2">
          ...
          <Link href="/discover">
            <div className="px-4 py-2 rounded-xl border flex justify-center items-center gap-2 bg-black text-white">
              Add Resident Artist
            </div>
          </Link>
          <Link href="/guest-spots">
            <div className="px-4 py-2 rounded-xl  flex justify-center items-center gap-2 border bg-primary text-white">
              Add Guest Spot
            </div>
          </Link>
        </div> */}
