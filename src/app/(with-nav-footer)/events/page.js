        ...
        <div className='container mx-auto'>
            ...
            <div className='flex flex-col justify-center items-center '>
                ...
                >
                    ...
                    <Form.Item name="eventName" label={<p className=" text-md">Event Name</p>}>
                        <Input required style={{ padding: "6px" }} className=" text-md" placeholder="Event Name" />
                    </Form.Item>
                    <Form.Item
                        name="type"
                    ...
                    >
                        <Select placeholder="Select">
                            <Select.Option value="Events slots1">Events slots 2</Select.Option>
                            <Select.Option value="Events slots1">Events slots 2</Select.Option>
                            <Select.Option value="Events slots1">Events slots 3</Select.Option>
                        </Select>
                    </Form.Item>
                    <Form.Item name="fee" label={<p className=" text-md">Registration fee (Optional)</p>}>
                        <Input required style={{ padding: "6px" }} className=" text-md" placeholder="Event Price" />
                    </Form.Item>
                    ...
                    <Form.Item name="description" label={<p className=" text-md">Description</p>}>
                        <Input.TextArea
                            required
                            style={{ padding: "6px" }}
                            className=" text-md"
                    ...
                    <Form.Item name="submit">
                        <button type="submit" className="bg-primary text-white font-bold py-2 px-4 rounded-xl focus:outline-none focus:shadow-outline w-full">Confirm</button>
                    </Form.Item>
                </Form>
            </div>
        </div>
