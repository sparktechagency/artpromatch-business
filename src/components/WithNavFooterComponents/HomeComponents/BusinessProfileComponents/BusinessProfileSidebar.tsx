...
const BusinessProfileSidebar = () => {
  ...
  const onFinish = (values: ServicesFormValues): void => {
    console.log(values);
  };
  // contact modal
  ...
  const onFinishForContact = (values: ContactFormValues): void => {
    console.log(values);
  };
    ...
    <div>
      <div className="container mx-auto">
        <div className="border p-3 rounded-lg mb-5">
          ...
          <p className="text-sm font-bold">
            Mon-Fri:<span className="font-normal"> 10:00 AM - 6:00 PM</span>
          </p>
          <p className="text-sm font-bold">
            Sat:<span className="font-normal"> 10:00 AM - 4:00 PM</span>
          </p>
          <p className="text-sm font-bold">
            Sun:<span className="font-normal">Closed</span>
          </p>
        </div>
        ...
        <div className="border p-3 rounded-lg mb-2">
          ...
          <div className="">
            <button className="px-4 py-2 rounded-3xl border mb-2">
              Realism
            </button>
            <button className="px-4 py-2 rounded-3xl border mb-2 ">
              Blackwork
        ...
        <div className="border p-3 rounded-lg mb-2">
          <h1 className="text-xl font-bold flex justify-between">
            Contact Alex Rivera{' '}
            <LuPenLine
              onClick={showModalForContact}
              className="bg-primary text-white h-7 w-7 p-1 rounded-full"
            />
          </h1>
      ...
      >
        ...
        <Modal
          ...
          footer={false}
        >
          <Form onFinish={onFinish} name="Services">
        ...
        <Modal
          ...
          onOk={handleOkForContact}
          onCancel={handleCancelForContact}
          footer={false}
        >
