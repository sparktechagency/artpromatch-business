...
import TattoDeatilsModal from './TattoDeatilsModal';
...
const FilteredTatto = () => {
  ...
  return (
    <div className="container mx-auto md:my-8 px-2 md:px-0">
      ...
      <div className="my-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p>
            ...
            {tattooCategories.find(cat => cat === selectedTab)}
          </p>
      ...
      <Modal
        ...
        width={800}
      >
        <TattoDeatilsModal selectedArtist={selectedArtist} />
      </Modal>
    </div>
  );
};
