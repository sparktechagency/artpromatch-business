...
type BookingModalOneProps = {
  handleOk: () => void;
  handleCancel: () => void;
};

const BookingModalOne: React.FC<BookingModalOneProps> = ({ handleOk, handleCancel }) => {
  ...
  return (
    <div>
      ...
      >
        <Form.Item
          name="service"
          label={<p className="font-bold">Choose a Service</p>}
        >
        ...
        <Form.Item
          name="service"
          label={<p className="font-bold">Service Type</p>}
        >
          <Select placeholder="Select">
        ...
        <Form.Item
          name="date"
          label={
            <div className="font-bold flex justify-between items-center gap-60">
              <p>Date and Time</p>
        ...
        <div className="flex justify-between items-center gap-2">
          ...
          <div>
            <p className="flex justify-center items-center border border-dashed px-2 py-1 rounded-lg">
              10:00 AM -11:30 AM
            </p>
          </div>
        </div>
