    ...
    <div className="px-2 md:px-0">
      ...
      <div className="container mx-auto  flex flex-col md:flex-row my-10">
        ...
        <div className="md:w-[80%] px-5">
          <div>
            ...
            <p>
              Rivera Ink Studio is a premier tattoo and piercing destination
              located in the heart of Brooklyn, NY. With a team of experienced
              resident artists and a rotating roster of talented guest artists,
              we specialize in a wide range of styles.
            </p>
          </div>
          <div className="my-5">
            <ResidentArtist />
      ...
      >
        ...
        <Modal
          ...
          footer={false}
        >
          <Form onFinish={onFinish} name="about you">
